                        ...
                        <div className="card container mb-4" key={cancha.id}>
                            ...
                            <div className="row">
                                ...
                                <div className="card-body col-6">
                                    ...
                                    {cancha.horarios.map((reserva) => (<button type="button"className={` ${reservas.includes(`${reserva.id}${reserva.hora}`) ? "btn btn-secondary m-2" : "btn-outline-secondary m-2"}`}style={{ height: "30px", width: "90px" }} key={reserva.id} onClick={() => reservar(reserva)}>{reserva.hora}</button>))}
                                </div>
